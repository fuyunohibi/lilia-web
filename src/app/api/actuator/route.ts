...
export async function POST_actuator(request: NextRequest, actuator_type: string) {
  try {
    ...
    const topic = `esp32/${deviceId}/${actuator_type}`;
...
export async function GET_actuator(request: NextRequest, actuator_type: string) {
